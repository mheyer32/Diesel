...
bool CROQTexture::open(const std::string& filename)
{
    ...
    cout << "RoQ: length " << rinfo->stream_length / 60000 << ":" << ((rinfo->stream_length + 500) / 1000) % 60
         << " video: " << rinfo->width << "x" << rinfo->height << " " << rinfo->num_frames
         << " frames  audio: " << rinfo->audio_channels << " channels" << endl;
