...
FMOD_DYN_FUNC("_FSOUND_SetMemorySystem@20", FSOUND_SetMemorySystem, signed char, 0,
              (void*, int, FSOUND_ALLOCCALLBACK, FSOUND_REALLOCCALLBACK, FSOUND_FREECALLBACK))
...
FMOD_DYN_FUNC("_FSOUND_File_SetCallbacks@20", FSOUND_File_SetCallbacks, void, ;
              , (FSOUND_OPENCALLBACK, FSOUND_CLOSECALLBACK, FSOUND_READCALLBACK, FSOUND_SEEKCALLBACK,
                 FSOUND_TELLCALLBACK))
...
FMOD_DYN_FUNC("_FSOUND_Sample_Alloc@28", FSOUND_Sample_Alloc, FSOUND_SAMPLE*, 0,
              (int, int, unsigned int, int, int, int, int))
...
FMOD_DYN_FUNC("_FSOUND_Sample_Lock@28", FSOUND_Sample_Lock, signed char, 0,
              (FSOUND_SAMPLE*, int, int, void**, void**, unsigned int*, unsigned int*))
FMOD_DYN_FUNC("_FSOUND_Sample_Unlock@20", FSOUND_Sample_Unlock, signed char, 0,
              (FSOUND_SAMPLE*, void*, void*, unsigned int, unsigned int))

FMOD_DYN_FUNC("_FSOUND_Sample_SetLoopMode@8", FSOUND_Sample_SetLoopMode, signed char, 0, (FSOUND_SAMPLE*, unsigned int))
FMOD_DYN_FUNC("_FSOUND_Sample_SetLoopPoints@12", FSOUND_Sample_SetLoopPoints, signed char, 0,
              (FSOUND_SAMPLE*, int, int))
FMOD_DYN_FUNC("_FSOUND_Sample_SetDefaults@20", FSOUND_Sample_SetDefaults, signed char, 0,
              (FSOUND_SAMPLE*, int, int, int, int))
FMOD_DYN_FUNC("_FSOUND_Sample_SetMinMaxDistance@12", FSOUND_Sample_SetMinMaxDistance, signed char, 0,
              (FSOUND_SAMPLE*, float, float))
...
FMOD_DYN_FUNC("_FSOUND_Sample_GetLoopPoints@12", FSOUND_Sample_GetLoopPoints, signed char, 0,
              (FSOUND_SAMPLE*, int*, int*))
FMOD_DYN_FUNC("_FSOUND_Sample_GetDefaults@20", FSOUND_Sample_GetDefaults, signed char, 0,
              (FSOUND_SAMPLE*, int*, int*, int*, int*))
...
FMOD_DYN_FUNC("_FSOUND_FX_SetChorus@32", FSOUND_FX_SetChorus, signed char, 0,
              (int, float, float, float, float, int, float, int))
FMOD_DYN_FUNC("_FSOUND_FX_SetCompressor@28", FSOUND_FX_SetCompressor, signed char, 0,
              (int, float, float, float, float, float, float))
FMOD_DYN_FUNC("_FSOUND_FX_SetDistortion@24", FSOUND_FX_SetDistortion, signed char, 0,
              (int, float, float, float, float, float))
FMOD_DYN_FUNC("_FSOUND_FX_SetEcho@24", FSOUND_FX_SetEcho, signed char, 0, (int, float, float, float, float, int))
FMOD_DYN_FUNC("_FSOUND_FX_SetFlanger@32", FSOUND_FX_SetFlanger, signed char, 0,
              (int, float, float, float, float, int, float, int))
FMOD_DYN_FUNC("_FSOUND_FX_SetGargle@12", FSOUND_FX_SetGargle, signed char, 0, (int, int, int))
FMOD_DYN_FUNC("_FSOUND_FX_SetI3DL2Reverb@52", FSOUND_FX_SetI3DL2Reverb, signed char, 0,
              (int, int, int, float, float, float, int, float, int, float, float, float, float))
FMOD_DYN_FUNC("_FSOUND_FX_SetParamEQ@16", FSOUND_FX_SetParamEQ, signed char, 0, (int, float, float, float))
FMOD_DYN_FUNC("_FSOUND_FX_SetWavesReverb@20", FSOUND_FX_SetWavesReverb, signed char, 0,
...
FMOD_DYN_FUNC("_FSOUND_3D_Listener_SetAttributes@32", FSOUND_3D_Listener_SetAttributes, void, ;
              , (float*, float*, float, float, float, float, float, float))
FMOD_DYN_FUNC("_FSOUND_3D_Listener_GetAttributes@32", FSOUND_3D_Listener_GetAttributes, void, ;
              , (float*, float*, float*, float*, float*, float*, float*, float*))
...
FMOD_DYN_FUNC("_FSOUND_Stream_Create@20", FSOUND_Stream_Create, FSOUND_STREAM*, 0,
              (FSOUND_STREAMCALLBACK, int, unsigned int, int, int))
FMOD_DYN_FUNC("_FSOUND_Stream_Play@8", FSOUND_Stream_Play, int, 0, (int, FSOUND_STREAM*))
FMOD_DYN_FUNC("_FSOUND_Stream_PlayEx@16", FSOUND_Stream_PlayEx, int, 0,
              (int, FSOUND_STREAM*, FSOUND_DSPUNIT*, signed char))
...
FMOD_DYN_FUNC("_FSOUND_Stream_SetEndCallback@12", FSOUND_Stream_SetEndCallback, signed char, 0,
              (FSOUND_STREAM*, FSOUND_STREAMCALLBACK, int))
FMOD_DYN_FUNC("_FSOUND_Stream_SetSynchCallback@12", FSOUND_Stream_SetSynchCallback, signed char, 0,
              (FSOUND_STREAM*, FSOUND_STREAMCALLBACK, int))
FMOD_DYN_FUNC("_FSOUND_Stream_GetSample@4", FSOUND_Stream_GetSample, FSOUND_SAMPLE*, 0, (FSOUND_STREAM*))
FMOD_DYN_FUNC("_FSOUND_Stream_CreateDSP@16", FSOUND_Stream_CreateDSP, FSOUND_DSPUNIT*, 0,
              (FSOUND_STREAM*, FSOUND_DSPCALLBACK, int, int))
...
FMOD_DYN_FUNC("_FSOUND_DSP_MixBuffers@28", FSOUND_DSP_MixBuffers, signed char, 0,
              (void*, void*, int, int, int, int, unsigned int))
...
FMOD_DYN_FUNC("_FSOUND_Geometry_AddPolygon@28", FSOUND_Geometry_AddPolygon, signed char, 0,
              (float*, float*, float*, float*, float*, unsigned int, float*))
...
FMOD_DYN_FUNC("_FSOUND_Geometry_Material_SetAttributes@20", FSOUND_Geometry_Material_SetAttributes, signed char, 0,
              (FSOUND_MATERIAL*, float, float, float, float))
FMOD_DYN_FUNC("_FSOUND_Geometry_Material_GetAttributes@20", FSOUND_Geometry_Material_GetAttributes, signed char, 0,
              (FSOUND_MATERIAL*, float*, float*, float*, float*))
FMOD_DYN_FUNC("_FSOUND_Geometry_Material_Set@4", FSOUND_Geometry_Material_Set, signed char, 0, (FSOUND_MATERIAL*))

FMOD_DYN_FUNC("_FSOUND_Reverb_SetProperties@4", FSOUND_Reverb_SetProperties, signed char, 0,
              (FSOUND_REVERB_PROPERTIES*))
FMOD_DYN_FUNC("_FSOUND_Reverb_GetProperties@4", FSOUND_Reverb_GetProperties, signed char, 0,
              (FSOUND_REVERB_PROPERTIES*))
FMOD_DYN_FUNC("_FSOUND_Reverb_SetChannelProperties@8", FSOUND_Reverb_SetChannelProperties, signed char, 0,
              (int, FSOUND_REVERB_CHANNELPROPERTIES*))
FMOD_DYN_FUNC("_FSOUND_Reverb_GetChannelProperties@8", FSOUND_Reverb_GetChannelProperties, signed char, 0,
              (int, FSOUND_REVERB_CHANNELPROPERTIES*))
...
FMOD_DYN_FUNC("_FMUSIC_SetRowCallback@12", FMUSIC_SetRowCallback, signed char, 0,
              (FMUSIC_MODULE*, FMUSIC_CALLBACK, int))
FMOD_DYN_FUNC("_FMUSIC_SetOrderCallback@12", FMUSIC_SetOrderCallback, signed char, 0,
              (FMUSIC_MODULE*, FMUSIC_CALLBACK, int))
FMOD_DYN_FUNC("_FMUSIC_SetInstCallback@12", FMUSIC_SetInstCallback, signed char, 0,
              (FMUSIC_MODULE*, FMUSIC_CALLBACK, int))
