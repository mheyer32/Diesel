...
public:
	...
	*/
	...
	Image(int width, int height, int bytesperpixel, int destinationformat, int srcformat ,const unsigned char* imagedata=0);
...
protected:
	...
	void	init(int width, int height, int bytesperpixel, int destinationformat, int srcformat ,const unsigned char* imagedata);
