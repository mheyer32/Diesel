...
Image::Image(int width, int height, int bytesperpixel, int destinationformat, int srcformat, const unsigned char* imagedata)
{
...
void Image::init(int width, int height, int bytesperpixel, int destinationformat, int srcformat ,const unsigned char* imagedata)
{
