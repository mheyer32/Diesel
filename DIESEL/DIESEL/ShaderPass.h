...
#define PASS_GLSTATE_MASK  (PASS_BLENDFUNC|PASS_ALPHAFUNC|PASS_DEPTHWRITE|PASS_LIGHTING|PASS_DEPTHFUNC|PASS_NODEPTHTEST)
#define PASS_TEXUNIT_MASK  (PASS_GLTCGEN)

#define	PASS_LIGHTMAP    (1<<16)
#define	PASS_ANIMMAP     (1<<19)
#define PASS_TEXENV		 ((1<<22))  // if PASS_TEXENV is set, it means that blending is needed
