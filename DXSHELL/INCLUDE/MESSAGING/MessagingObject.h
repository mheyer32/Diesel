...
#define MSG0(msgname)	namespace Msg { typedef Param msgname##_PARAM; }
#define MSG1(msgname, paramtype1) namespace Msg { typedef Param1<paramtype1> msgname##_PARAM; }
#define MSG2(msgname, paramtype1, paramtype2) namespace Msg { typedef Param2<paramtype1,paramtype2> msgname##_PARAM; }
#define MSG3(msgname, paramtype1, paramtype2, paramtype3) namespace Msg { typedef Param3<paramtype1,paramtype2,paramtype3> msgname##_PARAM; }
#define MSG4(msgname, paramtype1, paramtype2, paramtype3, paramtype4) namespace Msg { typedef Param4<paramtype1,paramtype2,paramtype3,paramtype4> msgname##_PARAM; }
...
namespace Msg
{
	...
	**/
	...
	protected:
		...
		**/
		virtual	 Msg::MSGRVAL handleMessage(Msg::MessagingObject *sender, Msg::MESSAGEID msgId, const Msg::Param &parameters=Msg::Param());
		...
		**/
		Msg::MSGRVAL sendMessage(Msg::MessagingObject *listener, Msg::MESSAGEID msgId, const Msg::Param &parameters=Param());
	...
	private:
		...
		**/
		struct MSGLISTENERENTRY
		{
			...
			MSGLISTENERENTRY(MessagingObject *msgobject, int priority=0): m_msgobject(msgobject),m_priority(priority) {};
...
#pragma warning (pop)
	...
	{
	public:
		typedef	 Msg::MSGRVAL (*MSGCALLBACKFUNC)(Msg::MessagingObject *sender, Msg::MESSAGEID msgId, const Msg::Param &parameters);
		
		MessageCallback(MSGCALLBACKFUNC func):m_callbackfunc(func){};
		/** Use this method to register a listener at a message server object.
		**/
		void registerForMessage(Msg::MessagingObject *sender, Msg::MESSAGEID msgId, int priority=0);
