...
public:
	Param3( P1 par1, P2 par2, P3 par3 )
		: Param2<P1, P2>( par1, par2 ), m_p3( par3 )
	{}
	P3 p3() const
	{	return m_p3; }
	void p3( P3 par3 )
...
public:
	Param4( P1 par1, P2 par2, P3 par3, P4 par4 )
		: Param3<P1, P2, P3>( par1, par2, par3 ), m_p4( par4 )
	{}
	P4 p4() const
	{	return m_p4; }
	void p4( P4 par4 )
...
public:
	Param5( P1 par1, P2 par2, P3 par3, P4 par4, P5 par5 )
		: Param4<P1, P2, P3, P4>( par1, par2, par3, par4 ), m_p5( par5 )
	{}
	P5 p5() const
	{	return m_p5; }
	void p5( P5 par5 )
...
#		if GCC_VERSION == 30200
	assert( std::string( typeid( p ).name() ) ==
		std::string( typeid( Param1<P1> ).name() ) );
#		else
...
#		if GCC_VERSION == 30200
	assert( std::string( typeid( p ).name() ) ==
		std::string( typeid( Param2<P1, P2> ).name() ) );
#		else
...
#		if GCC_VERSION == 30200
	assert( std::string( typeid( p ).name() ) ==
		std::string( typeid( Param3<P1, P2, P3> ).name() ) );
#		else
...
#		if GCC_VERSION == 30200
	assert( std::string( typeid( p ).name() ) ==
		std::string( typeid( Param4<P1, P2, P3, P4> ).name() ) );
#		else
...
#		if GCC_VERSION == 30200
	assert( std::string( typeid( p ).name() ) ==
		std::string( typeid( Param5<P1, P2, P3, P4, P5> ).name() ) );
#		else
