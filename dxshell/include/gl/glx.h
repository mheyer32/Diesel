...
**
** $Header: e:\CVSRepository/CVSROOT/dxshell/include/gl/GLX.H,v 1.1 2003-06-26 09:45:00 skynet Exp $
*/
...
extern void glXCopyContext(Display* dpy, GLXContext src, GLXContext dst, unsigned int mask);

extern GLXContext glXCreateContext(Display* dpy, XVisualInfo* vis, GLXContext share_list, Bool direct);
